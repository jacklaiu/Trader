...
fast_ema = 6
slow_ema = 23
timeArr = util.getTimeSerial(starttime='2018-11-20 09:00:00', count=200000, periodSec=61)
df = None
security = 'MA8888.XZCE' # RB8888.XSGE JD8888.XDCE HC8888.XSGE MA8888.XZCE
frequency = '30m'
msg = {
    'df': df,
    'position': 0,
